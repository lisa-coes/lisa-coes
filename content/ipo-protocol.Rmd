...
- datos
- abierto
title: IPO (Input-Procesamiento-Output) 
linkcolor: blue
link-citations: yes
editor_options:
...
# Protocolo para flujo de investigación reproducible  <img src="../input/ipo-logo.png" alt=" " style="float: right;width: 25%;max-height: 100%" />


Para bajar un ejemplo de la estructura de carpetas click [aquí](https://lisa-coes.github.io/ipo/IPO_template/IPO-Project_template.tar.gz).
