...
Un artículo en cualquiera de las tres etapas puede ser publicado de manera abierta, lo cual no afecta a la posterior indexación en revistas. Recomendamos hospedar el manuscrito en [SocArxiv](https://osf.io/preprints/socarxiv){target="_blank"}. Para ello, debemos ingresar al [OSF (Open Science Framework)](https://osf.io/preprints/){target="_blank"} y cargar el manuscrito en formato _.pdf_. Finalmente, obtenemos un Identificador del Objeto Digital (DOI) que permite encontrar y citar el documento.
...
<a href="https:&#x2F;&#x2F;www.canva.com&#x2F;design&#x2F;DAEoyGJC-4E&#x2F;watch?utm_content=DAEoyGJC-4E&amp;utm_campaign=designshare&amp;utm_medium=embeds&amp;utm_source=link" target="_blank" rel="noopener">
