...
```{r, results='asis', echo = F}
 ...
 tab01 <- tab01 %>%
 dplyr::mutate(enlace = cell_spec(enlace, "html", link = enlace))
 tab01 %>%
 kableExtra::kbl(., full_width = T, linesep = "", escape = FALSE,
 col.names = c("Plantilla","Descripción","Nombre","Enlace"),row.names = F) %>%
...
🔴 En el video a continuación revisaremos cómo completar una plantilla en cada uno de estos tres escenarios:  
...
<iframe frameborder="0" style="width:100%;height:575px;" src="https://viewer.diagrams.net/?tags=%7B%7D&edit=_blank&layers=1&nav=1&title=Preguntas_plantillas#Uhttps%3A%2F%2Fdrive.google.com%2Fuc%3Fid%3D1zuZuJjKFumyI-HqlbXxdU7I8ImnYBCOq%26export%3Ddownload"></iframe>
