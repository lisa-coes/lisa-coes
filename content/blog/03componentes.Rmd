...
La forma en que están organizadas las partes de un proyecto es fundamental para cumplir a cabalidad con el objetivo de hacerlo reproducible. Esta organización se puede sintetizar como un esquema que involucra tres elementos: `(1) Datos`, `(2) Métodos` y `(3) Resultados`.

Este esquema busca sintetizar algunos de los protocolos más usados en ciencias sociales, describiendo los principales elementos de un proyecto reproducible.
...
Estas instrucciones pueden ir incluidas en un archivo `README` que puede seguir la siguiente organización:
</div>
...
* Para ver mayores destalles respecto a el contenido y estructura de un proyecto reproducible, puedes hacer click aquí:
...
Para toda fuente de datos procesada, tanto intermedia como final, se debe incluir el libro de códigos de la base, con sus variables correctamente etiquetadas, y la fecha de creación y versión de la misma.
...
Con los métodos nos referimos a todos los procedimientos del proyecto relacionados con la **(1) preparación** y **(2) análisis** de datos.

#### **`(1) Preparación`**

La preparación de los datos cumple una función muy importante para el desarrollo de un artículo: la de generar los datos que emplearemos en análisis del estudio. Considerando esto, el objetivo final de este documento es generar una base de datos procesada, que contenga solamente los datos importantes para analizar.
...
Una vez contamos con nuestra base de datos procesada podemos analizar los datos. En el documento de análisis de datos se procede a elaborar todas las tablas, gráficos, pruebas estadísticas etc. que vayan a ser introducidos en el artículo final.

Que contenga los análisis necesarios para probar las hipótesis de investigación.
...
🗸  Más información sobre la sección de método, puedes hacer click aquí:

<a class = "btn btn-template-main" href="https://lisa-coes.github.io/lisa-book/herramientas-para-los-an%C3%A1lisis-reproducibles.html#m%C3%A9todos" target="_blank">Preparación y análisis </a>
...
🔴 Finalmente, al incorporar código de análisis es posible generar documentos **autocontenidos**, es decir, no es necesario recurrir a imágenes o tablas externas, sino que es posible producirlas en el mismo documento.
...
<a class = "btn btn-template-main" href="https://lisa-coes.github.io/lisa-book/herramientas-para-los-an%C3%A1lisis-reproducibles.html#texto-plano-y-documentos-din%C3%A1micos" target="_blank">Documentos dinámicos</a>

## Paso 4: Control de versiones {#paso4}

A modo global, el **control de versiones** nos permite rastrear los cambios en un documento o conjunto de archivos, es decir, saber _cuáles/qué_, _cuándo_  y _quién_ ha realizado estos cambios.
...
⭕ Registra _qué_, _cuándo_ y _quién_ realizó cambios
...
Puedes dejar tus comentarios y dudas sobre cómo generar un proyecto reproducible. De todas formas puedes [contactarnos](/contact/)
